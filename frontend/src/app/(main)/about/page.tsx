          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <p className="text-[#7a5230] mb-5 leading-relaxed text-lg">
                "Kén" như một cái kén ôm trọn tâm hồn và sự bình yên của bạn, là
                nơi giúp bạn gạt bỏ những bộn bề của cuộc sống để hòa mình vào
                nhịp sống giản dị, mộc mạc của người dân bản địa.
              </p>
              <p className="text-[#7a5230] mb-5 leading-relaxed text-lg">
                Tại đây, bạn sẽ tìm thấy sự bình yên, những trải nghiệm chân
                thực và cảm giác trở về "nhà" của một vùng đất mới. Đó là khoảnh
                khắc bạn cảm thấy bình yên, như đôi cánh bướm nở rộ sức sống sau
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">
                        123 Đường Nguyễn Văn Linh, Quận Hải Châu, Đà Nẵng, Việt
                        Nam
                      </p>
                    </div>
                  </div>
