...
export function Footer() {
  return (
    <footer className="bg-black text-white text-sm font-sans pt-20">
      <div className="mx-auto">
        ...
        <div className="lg:hidden px-6 py-8 flex flex-col items-center text-center">
          ...
          {/* Social Media Icons */}
          <div className="flex justify-center space-x-4 mb-6 border-t border-b border-gray-600 w-full py-6">
            <Link
              href="#"
