...
export default function FacilitiesGrid() {
  ...
  const facilities: Facility[] = [
    ...
    // },
    {
      ...
      title: t("home.FacilitiesGrid.roomServiceTitle1"),
      description: t("home.FacilitiesGrid.roomServiceDescription1"),
    },
    {
      icon: (
        <svg
      ...
      title: t("home.FacilitiesGrid.roomServiceTitle2"),
      description: t("home.FacilitiesGrid.roomServiceDescription2"),
    },
    {
      icon: (
        <svg
      ...
      title: t("home.FacilitiesGrid.roomServiceTitle3"),
      description: t("home.FacilitiesGrid.roomServiceDescription3"),
    },
    // {
    //   icon: (
    //     <svg
  ...
  return (
    ...
    >
      <div className="container mx-auto max-w-7xl">
        ...
        >
          <Title
            title={t("home.FacilitiesGrid.title")}
            titleColor="#5a8d69"
            subtitle={t("home.FacilitiesGrid.subtitle")}
